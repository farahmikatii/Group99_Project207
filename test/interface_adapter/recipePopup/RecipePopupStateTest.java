...
public class RecipePopupStateTest {
    ...
    public void testRecipePopupStateCopyConstructor() {
        // Arrange
        CommonRecipe testRecipe = new CommonRecipe("TestRecipe", "test.jpg", "http://example.com", "Ingredient1");
    ...
    public void testInitialization() {
        ...
        assertEquals(commonRecipe.getIngredients(), state.getIngredients());
    }
    ...
    public void testSetIngredients() {
        ...
        // Create an instance of CommonRecipe for testing
        CommonRecipe commonRecipe = new CommonRecipe("Test Recipe", "", "", "food");
